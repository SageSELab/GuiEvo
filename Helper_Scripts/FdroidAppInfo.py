...
apkRootDirectory = "/Users/user/Documents/Academic/Research/GuiEvo/APK/"


def downloadApk():
    print("=================================================")
    print("|     Step-2: Downloading the .apk files now    |")
    print("=================================================")
    print("\n")
    apps = appNamesList
    count = 1
    for app in apps:
        ...
        if not os.path.exists(directory):
            os.mkdir(path)
        sourceDirectory = "/Users/user/Library/Caches/fdroidcl/apks/"
...
def makeCSV():
    print("==========================================")
    print("|     Step-1: Making the CSV file now    |")
    print("==========================================")
    print("\n")
    apps = appNamesList
    count = 1
